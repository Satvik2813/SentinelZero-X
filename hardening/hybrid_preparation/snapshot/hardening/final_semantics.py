...
def run(module=agent):
    ...
    checks={
        ...
        # Regression analysis restores baseline anchors; the former assertions
        # required the now-reverted confidence inflation irrespective of accuracy.
        'escalation_baseline_anchor': results['clear-escalation']['confidence']==.85,
        ...
        'warn_baseline_anchor': module._confidence('warn',4,0,0)==.75,
    }
